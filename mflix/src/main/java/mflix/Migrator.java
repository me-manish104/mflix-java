...
public class Migrator {
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://m220student:m220password@mflix-pmyac.mongodb.net/sample_mflix?retryWrites=true&w=majority";
        ...
        Bson dateStringFilter = Document.parse("{'lastupdated':{'$type':2}}");
        ...
        Bson ratingStringFilter = Document.parse("{'imdb.rating':{'$type':2}}");
